...
public class WiFi {
  ...
  private static final String SERVER_IP = "192.168.2.45"; // .8
  ...
  // Red Team area
  private static int SZR_LL_x = 0, SZR_LL_y = 0, SZR_UR_x = 0, SZR_UR_y = 0;
  ...
  private static void assignTeamColor(int color) {
    ...
    } else if (color == 1) // GREEN
    {
      ...
      opp_SZ_LL_x = SZR_LL_x;
      opp_SZ_LL_y = SZR_LL_y;
      opp_SZ_UR_x = SZR_UR_x;
      opp_SZ_UR_y = SZR_UR_y;
    } else {
  ...
  /**
   * finds the first set of coordinates that the robot will localize to depending on the starting
   * area and the size of the platform
   * 
