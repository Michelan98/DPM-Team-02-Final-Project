...
public class Lab5 {
	...
	public static void main(String str[]) {
		...
		WiFi.getData();
		System.out.println(""+WiFi.corner+"llx"+WiFi.LL_x+" lly"+ WiFi.LL_y+" localizeX"+WiFi.localizeX+" localizeY"+
				WiFi.localizeY+ " localizetheta"+ WiFi.localizeTheta+ " tnllx"+WiFi.TunLL_x+" tnlly"+WiFi.TunLL_y+ 
				" tnurx"+WiFi.TunUR_x+ " tnury"+WiFi.TunUR_y+ " szllx"+WiFi.SZ_LL_x+ " szlly"+WiFi.SZ_LL_y+ " szurx"+
				WiFi.SZ_UR_x+" szury"+ WiFi.SZ_UR_y);
